                ...
                steps {
                    script {
                        ...
                        ARTIFACT_VERSION = sh (
                         ...
                         FINAL_ARTIFACT=$ARTIFACT_NAME$ARTIFACT_TYPE
                        ...
                        dockerImage = docker.build("kumarakuruparans/docker-example:$ARTIFACT_VERSION","--build-arg JAR_FILE=$FINAL_ARTIFACT -f Dockerfile  .")
                    }
                }
         }
